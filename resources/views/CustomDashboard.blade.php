...
<body>
    <x-app-layout>
        ...
        <div class="px-5 rounded-3">
            ...
            <h1 class="display-5 fw-bold">HELLO CUSTOMER</h1>
            <P>You can track your food order from here</P>
                <div class="container py-3">
                    <a class="btn btn-info btn-sm" href="{{route('myOrders')}}">View Order</a>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="card bg__order__card">
                                                <div class="card-body text-light">
                                                    ...
                                                    <select name="dishName[]" class="form-control" required="required" autocomplete="autofocus">
                                                        ...
                                                        <option value="Haweian">Hawian</option> <br><br>
